package org.daylight.pathweaver.service.domain.stub;

import org.daylight.pathweaver.core.api.v1.*;
...
public class StubFactory {
    ...
    public static org.daylight.pathweaver.core.api.v1.VirtualIp createSharedDataModelVipForPost() {
        return createMinimalDataModelVipForPost(VIP1_ID, null, null, null);
    }

    public static org.daylight.pathweaver.core.api.v1.VirtualIp createDataModelVipWithIpVersionForPost() {
        return createMinimalDataModelVipForPost(null, null, org.daylight.pathweaver.core.api.v1.IpVersion.valueOf(VIP1_VERSION), null);
    }

    public static org.daylight.pathweaver.core.api.v1.VirtualIp createDataModelVipWithVipTypeForPost() {
        return createMinimalDataModelVipForPost(null, null, null, VipType.valueOf(VIP1_TYPE));
    }

    public static org.daylight.pathweaver.core.api.v1.VirtualIp createHydratedDataModelVipForPost() {
        return createMinimalDataModelVipForPost(null, null, org.daylight.pathweaver.core.api.v1.IpVersion.valueOf(VIP1_VERSION), VipType.valueOf(VIP1_TYPE));
    }

    protected static org.daylight.pathweaver.core.api.v1.VirtualIp createMinimalDataModelVipForPost(Integer id, String address, org.daylight.pathweaver.core.api.v1.IpVersion ipVersion, VipType vipType) {
    ...
    public static org.daylight.pathweaver.core.api.v1.Node createMinimalDataModelNodeForPost() {
        return createDataModelNodeForPost(null, NODE1_ADDRESS, NODE1_PORT, null, true, null);
    }

    public static org.daylight.pathweaver.core.api.v1.Node createHydratedDataModelNode() {
        return createDataModelNodeForPost(NODE1_ID, NODE1_ADDRESS, NODE1_PORT, NODE1_WEIGHT, NODE1_ENABLED, NODE1_STATUS);
    }

    protected static org.daylight.pathweaver.core.api.v1.Node createDataModelNodeForPost(Integer id, String address, Integer port, Integer weight, boolean enabled, String status) {
        org.daylight.pathweaver.core.api.v1.Node node = new org.daylight.pathweaver.core.api.v1.Node();
    ...
    public static org.daylight.pathweaver.core.api.v1.LoadBalancer createMinimalDataModelLoadBalancerForPost() {
        org.daylight.pathweaver.core.api.v1.LoadBalancer loadBalancer = new org.daylight.pathweaver.core.api.v1.LoadBalancer();

        loadBalancer.setName(LOAD_BALANCER_NAME);

        org.daylight.pathweaver.core.api.v1.Node node1 = createDataModelNodeForPost(null, NODE1_ADDRESS, NODE1_PORT, null, true, null);
        final org.daylight.pathweaver.core.api.v1.Nodes nodes = new org.daylight.pathweaver.core.api.v1.Nodes();
        nodes.getNodes().add(node1);
        loadBalancer.setNodes(nodes);

        final VirtualIps vips = new VirtualIps();
        loadBalancer.setVirtualIps(vips);

        return loadBalancer;
    }

    public static org.daylight.pathweaver.core.api.v1.LoadBalancer createHydratedDataModelLoadBalancerForPost() {
        org.daylight.pathweaver.core.api.v1.LoadBalancer loadBalancer = createMinimalDataModelLoadBalancerForPost();
        ...
        loadBalancer.getNodes().getNodes().get(0).setEnabled(NODE1_ENABLED);

        org.daylight.pathweaver.core.api.v1.VirtualIp virtualIp1 = new org.daylight.pathweaver.core.api.v1.VirtualIp();
        virtualIp1.setType(org.daylight.pathweaver.core.api.v1.VipType.fromValue(VIP1_TYPE));
        virtualIp1.setIpVersion(org.daylight.pathweaver.core.api.v1.IpVersion.fromValue(VIP1_VERSION));
        VirtualIps vips = new VirtualIps();
        vips.getVirtualIps().add(virtualIp1);

        loadBalancer.setVirtualIps(vips);

        org.daylight.pathweaver.core.api.v1.VirtualIp virtualIp2 = new org.daylight.pathweaver.core.api.v1.VirtualIp();
    ...
    public static org.daylight.pathweaver.core.api.v1.LoadBalancer createHydratedDataModelLoadBalancer() throws Exception {
        ...
        virtualIp1.setType(org.daylight.pathweaver.core.api.v1.VipType.fromValue(VIP1_TYPE));
        virtualIp1.setIpVersion(org.daylight.pathweaver.core.api.v1.IpVersion.fromValue(VIP1_VERSION));
        org.daylight.pathweaver.core.api.v1.VirtualIps vips = new  org.daylight.pathweaver.core.api.v1.VirtualIps();
        vips.getVirtualIps().add(virtualIp1);
        loadBalancer.setVirtualIps(vips);

        org.daylight.pathweaver.core.api.v1.Node node1 = createDataModelNodeForPost(NODE1_ID, NODE1_ADDRESS, NODE1_PORT, NODE1_WEIGHT, NODE1_ENABLED, NODE1_STATUS);
        org.daylight.pathweaver.core.api.v1.Node node2 = createDataModelNodeForPost(NODE2_ID, NODE2_ADDRESS, NODE2_PORT, NODE2_WEIGHT, NODE2_ENABLED, NODE2_STATUS);
        final org.daylight.pathweaver.core.api.v1.Nodes nodes = new org.daylight.pathweaver.core.api.v1.Nodes();
        nodes.getNodes().add(node1);
    ...
    public static LoadBalancer createHydratedDomainLoadBalancer() {
        ...
        virtualIp1.setId(VIP1_ID);
        virtualIp1.setAddress(VIP1_ADDRESS);
        virtualIp1.setIpVersion(org.daylight.pathweaver.service.domain.entity.IpVersion.valueOf(VIP1_VERSION));
        virtualIp1.setVipType(org.daylight.pathweaver.service.domain.entity.VirtualIpType.valueOf(VIP1_TYPE));
    ...
    public static LoadBalancer createMinimalDomainLoadBalancer() {
        ...
        vip.setIpVersion(org.daylight.pathweaver.service.domain.entity.IpVersion.IPV4);
    ...
    public static org.daylight.pathweaver.core.api.v1.HealthMonitor createHydratedDataModelConnectMonitorForPut() {
        org.daylight.pathweaver.core.api.v1.HealthMonitor monitor = new org.daylight.pathweaver.core.api.v1.HealthMonitor();
    ...
    public static org.daylight.pathweaver.core.api.v1.HealthMonitor createHydratedDataModelHttpMonitorForPut() {
        org.daylight.pathweaver.core.api.v1.HealthMonitor monitor = createHydratedDataModelConnectMonitorForPut();
    ...
    public static org.daylight.pathweaver.core.api.v1.ConnectionThrottle createHydratedDataModelConnectionThrottle() {
        org.daylight.pathweaver.core.api.v1.ConnectionThrottle throttle = new org.daylight.pathweaver.core.api.v1.ConnectionThrottle();
    ...
    public static SessionPersistence createHydratedDataModelSessionPersistence() {
        org.daylight.pathweaver.core.api.v1.SessionPersistence sessionPersistence = new org.daylight.pathweaver.core.api.v1.SessionPersistence();
        sessionPersistence.setPersistenceType(SESSION_PERSISTENCE_TYPE);
        return sessionPersistence;
    }

    public static org.daylight.pathweaver.service.domain.entity.SessionPersistence createHydratedDomainSessionPersistence() {
        org.daylight.pathweaver.service.domain.entity.SessionPersistence sessionPersistence = new org.daylight.pathweaver.service.domain.entity.SessionPersistence();
    ...
    public static org.daylight.pathweaver.core.api.v1.VirtualIp createHydratedDataModelVirtualIp() {
        org.daylight.pathweaver.core.api.v1.VirtualIp virtualIp = new org.daylight.pathweaver.core.api.v1.VirtualIp();
    ...
    public static LoadBalancerJoinVip createHydratedDomainVirtualIpv6() {
        ...
        virtualIp.setIpVersion(org.daylight.pathweaver.service.domain.entity.IpVersion.IPV6);
    ...
    public static VirtualIp createHydratedDomainVirtualIp() {
        ...
        virtualIp.setIpVersion(org.daylight.pathweaver.service.domain.entity.IpVersion.valueOf(VIP1_VERSION));
        return virtualIp;
    }

    public static org.daylight.pathweaver.core.api.v1.HealthMonitor createHydratedDataModelHealthMonitor() {
        org.daylight.pathweaver.core.api.v1.HealthMonitor healthMonitor = new org.daylight.pathweaver.core.api.v1.HealthMonitor();
