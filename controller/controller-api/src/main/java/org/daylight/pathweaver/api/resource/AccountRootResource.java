...
public class AccountRootResource {
    ...
    private final Logger logger = Logger.getLogger(AccountRootResource.class);
    ...
    public AccountRootResource()
    {
        logger.debug("Instantiating am AccountRootResource bean...");
    }
