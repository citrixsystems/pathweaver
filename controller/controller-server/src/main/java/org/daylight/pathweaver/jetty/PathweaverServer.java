package org.daylight.pathweaver.jetty;
...
public class PathweaverServer {
    private final int port;

    public PathweaverServer() {
        port = Integer.parseInt(System.getProperty("port", "8080"));
    }

    public static void main(String[] args) throws Exception {
        PathweaverServer as = new PathweaverServer();
    ...
    private void start() throws IOException {
        ...
        try {
            ...
            ProtectionDomain protectionDomain = PathweaverServer.class.getProtectionDomain();
