...
public class HealthMonitorMappingTest {
    ...
    public static class WhenMappingFromApiToDomain extends MappingBase {
        private org.daylight.pathweaver.core.api.v1.HealthMonitor apiHealthMonitor;
        private org.daylight.pathweaver.service.domain.entity.HealthMonitor domainHealthMonitor;

        @Before
        public void setUp() throws Exception {
            apiHealthMonitor = StubFactory.createHydratedDataModelHealthMonitor();
            domainHealthMonitor = mapper.map(apiHealthMonitor, org.daylight.pathweaver.service.domain.entity.HealthMonitor.class);
        }

        @Test
        public void shouldNotFailWhenApiMonitorIsEmpty() {
            apiHealthMonitor = new org.daylight.pathweaver.core.api.v1.HealthMonitor();
            try {
                domainHealthMonitor = mapper.map(apiHealthMonitor, org.daylight.pathweaver.service.domain.entity.HealthMonitor.class);
            } catch (Exception e) {
    ...
    public static class WhenMappingFromDomainToApi extends MappingBase {
        ...
        public void setUp() throws Exception {
            ...
            apiHealthMonitor = mapper.map(domainHealthMonitor, org.daylight.pathweaver.core.api.v1.HealthMonitor.class);
        }

        @Test
        public void shouldNotFailWhenDomainMonitorIsEmpty() {
            domainHealthMonitor = new org.daylight.pathweaver.service.domain.entity.HealthMonitor();
            try {
                apiHealthMonitor = mapper.map(domainHealthMonitor, org.daylight.pathweaver.core.api.v1.HealthMonitor.class);
            } catch (Exception e) {
