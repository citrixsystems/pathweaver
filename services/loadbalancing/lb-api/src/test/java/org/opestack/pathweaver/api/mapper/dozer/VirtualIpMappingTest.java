...
public class VirtualIpMappingTest {
    ...
    public static class WhenMappingAVirtualIpFromApiToDomainIpv4 extends MappingBase {
        private org.daylight.pathweaver.core.api.v1.VirtualIp apiVirtualIp;
        private org.daylight.pathweaver.service.domain.entity.LoadBalancerJoinVip domainLbJoinVip;

        @Before
        public void setUp() throws Exception {
            apiVirtualIp = StubFactory.createHydratedDataModelVirtualIp();
            apiVirtualIp.setIpVersion(IpVersion.IPV4);
            domainLbJoinVip = mapper.map(apiVirtualIp, org.daylight.pathweaver.service.domain.entity.LoadBalancerJoinVip.class);
        }

        @Test
        public void shouldNotFailWhenApiVirtualIpIsEmpty() {
            apiVirtualIp = new org.daylight.pathweaver.core.api.v1.VirtualIp();
            try {
                domainLbJoinVip = mapper.map(apiVirtualIp, org.daylight.pathweaver.service.domain.entity.LoadBalancerJoinVip.class);
            } catch (Exception e) {
    ...
    public static class WhenMappingAVirtualIpFromDomainIpv4ToApi extends MappingBase {
        ...
        public void setUp() throws Exception {
            ...
            apiVirtualIp = mapper.map(domainLbJoinVip, org.daylight.pathweaver.core.api.v1.VirtualIp.class);
        }

        @Test
        public void shouldNotFailWhenApiVirtualIpIsEmpty() {
            domainLbJoinVip = new org.daylight.pathweaver.service.domain.entity.LoadBalancerJoinVip();
            try {
                apiVirtualIp = mapper.map(domainLbJoinVip, org.daylight.pathweaver.core.api.v1.VirtualIp.class);
            } catch (Exception e) {
