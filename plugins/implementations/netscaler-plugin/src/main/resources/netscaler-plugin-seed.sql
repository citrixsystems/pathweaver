LOCK TABLES `plugin_cluster` WRITE;
INSERT INTO `plugin_cluster` (cluster_ipv6_cidr, description, name, password, username) VALUES ('fd24:f480:ce44:91bc::/64', 'User-facing web tier cluster','Helios-Cluster-1','626a47d059552219760a2d38a130cd80', 'user1');
UNLOCK TABLES;

LOCK TABLES `plugin_host` WRITE;
INSERT INTO `plugin_host` (endpoint, endpoint_active, host_status, name, password, username, cluster_id) VALUES ('http://localhost:4301/lbservice/v1',1,'ACTIVE_TARGET', 'Helios-1','626a47d059552219760a2d38a130cd80', 'user1', 1);
UNLOCK TABLES;

LOCK TABLES `plugin_virtual_ipv4` WRITE;
/*!40000 ALTER TABLE `plugin_virtual_ipv4` DISABLE KEYS */;
INSERT INTO `plugin_virtual_ipv4` (address, type, is_allocated, last_allocation, last_deallocation, cluster)
...
/*!40000 ALTER TABLE `plugin_virtual_ipv4` ENABLE KEYS */;
UNLOCK TABLES;
