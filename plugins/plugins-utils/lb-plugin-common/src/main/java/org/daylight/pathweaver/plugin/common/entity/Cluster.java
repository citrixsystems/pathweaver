package org.daylight.pathweaver.plugin.common.entity;
...
@Table(name = "plugin_cluster")
public class Cluster extends org.daylight.pathweaver.service.domain.entity.Entity implements Serializable {
