...
package org.daylight.pathweaver.plugin.common;
...
public class EndpointUtils {
    ...
    private void checkAndSetIfEndPointBadInternal(LoadBalancerEndpointConfiguration config, Exception exc) throws PluginException, Exception {
    ...
    protected static void checkAndSetIfEndPointBad(LoadBalancerEndpointConfiguration config, Exception exc) throws PluginException, Exception {
        setEndpointUtilsSingleton();
