...
import org.daylight.pathweaver.api.validation.validator.builder.*;
...
public class LoadBalancerValidatorTest {
    ...
    public static class WhenValidatingPostContext {
        ...
        public void setUp() {
            ...
            validator = new LoadBalancerValidator(
                    new LoadBalancerValidatorBuilder(
                            ...
                            new NodesValidatorBuilder(new NodeValidatorBuilder()),
                            new VirtualIpsValidatorBuilder(new VirtualIpValidatorBuilder()),
        ...
        public void shouldRejectIdForVipIfTypeIsSet() {
            loadBalancer = StubFactory.createHydratedDataModelLoadBalancerForPost();
            loadBalancer.getVirtualIps().getVirtualIps().get(0).setId(1234);
        ...
        public void shouldAcceptIdOnly() {
            VirtualIps vips = loadBalancer.getVirtualIps();

            if (vips != null) {
                vips.getVirtualIps().clear();
            } else {
                vips = new VirtualIps();
            ...
            vipper.setId(23);
            loadBalancer.getVirtualIps().getVirtualIps().add(vipper);
        ...
        public void shouldRejectMultipleVips() {
            loadBalancer.getVirtualIps().getVirtualIps().clear();
            ...
            loadBalancer.getVirtualIps().getVirtualIps().add(vip);
            loadBalancer.getVirtualIps().getVirtualIps().add(vip2);
        ...
        public void shouldReject26OrMoreNodes() {
            for (int i = 0; i < 26; i++) {
                ...
                node.setPort(80 + i);
                loadBalancer.getNodes().getNodes().add(node);
            }
        ...
        public void shouldRejectWhenMissingNodes() {
            loadBalancer.getNodes().getNodes().clear();
            ValidatorResult result = validator.validate(loadBalancer, POST);
            assertFalse(result.passedValidation());
        }
    ...
    public static class WhenValidatingPutContext {
        ...
        public void setupValidLoadBalancerObject() {
            ...
            loadBalancer.setVirtualIps(null);
        }
        ...
        public void shouldRejectWhenVirtualIpsIsNotEmpty() {
            ...
            virtualIps.getVirtualIps().add(new VirtualIp());
